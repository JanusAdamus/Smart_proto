...
El proyecto prioriza una experiencia de conexión sencilla: el generador busca
automáticamente un puerto serie USB, el relay de la Raspberry Pi arranca con
...
- **Simulador:** genera cada segundo un telegrama con potencia, energía
  acumulada y voltaje, protegido con CRC16/ARC.
- **Relay:** detecta el puerto que realmente está transmitiendo telegramas y
  reenvía el flujo a uno o más clientes TCP.
- **Dashboard:** valida el CRC, interpreta los campos DSMR y muestra el valor
  actual, una gráfica y un registro de recepción.

## Funciones principales

- Telegramas DSMR sintéticos con códigos OBIS y checksum válido.
- Detección y reconexión automática del puerto serie.
