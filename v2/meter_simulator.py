...
class SmartMeterGeneratorUI:
    ...
    def _build(self):
        ...
        self.power_label = self._value(values, 0, "Power", "-- kW")
        self.energy_label = self._value(values, 1, "Energy T2", "-- kWh")
        self.voltage_label = self._value(values, 2, "Voltage L1", "-- V")
        self.gas_label = self._value(values, 3, "Gas", "-- m³")
        ...
        tk.Label(
            self.root,
            text="DSMR 5.0.2  |  Serial output  |  1 telegram per second",
            fg="#666666",
            font=("Segoe UI", 9),
        ).pack(pady=(0, 12))
